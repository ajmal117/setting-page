        ...
        <div className=" ">
          ...
          <div className="h-screen w-72 flex flex-col justify-between border border-b-0">
            <div className="  gap-4 pt-10  flex flex-col  items-center ">
              <div className="  hover:cursor-pointer flex gap-2 rounded-md active:bg-violet-50 hover:bg-violet-50  hover:border-l-4 hover:border-[#8B3DFF] px-5 py-3 h-12   w-64">
                <Insight className={""} />
              ...
              <div className= "hover:cursor-pointer flex gap-2 rounded-md hover:bg-violet-50  hover:border-l-4 hover:border-[#8B3DFF] px-5 py-3 h-12   w-64">
            ...
            <div className="w-72  border  pt-3 border-b-0 flex flex-col  items-center ">
              <div className= "hover:cursor-pointer flex gap-2 rounded-md   px-5 py-3  w-64">
